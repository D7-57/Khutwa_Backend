...
_QUESTIONS_IT: list[dict] = [
    {
        ...
        "options": [
            ...
            {"id": "it_q1_f", "text_en": "Understanding how systems work and bridging IT with business needs",
             "text_ar": "فهم كيفية عمل الأنظمة وربط تقنية المعلومات باحتياجات الأعمال", "roles": ["systems_analyst", "biz_analyst_it"]},
        ],
    },
    {
        "id": "it_q2",
    ...
    },
    {
        ...
        "options": [
            ...
            {"id": "it_q3_f", "text_en": "Data analytics platforms, BI tools, and reporting infrastructure",
             "text_ar": "منصات تحليل البيانات وأدوات ذكاء الأعمال وبنية التقارير", "roles": ["data_analyst", "biz_analyst_it"]},
        ],
    },
    {
        "id": "it_q4",
...
class SurveyResult(BaseModel):
    ...
    top_roles: list[SurveyRoleResult]   # top 3–6 roles; frontend shows 3 at a time (reroll support)
...
def submit_survey(
    ...
    # Return up to 6 ranked roles so the frontend can offer a reroll (show alt set of 3).
    # Only include roles that have a display name defined.
    top6_keys = [rk for rk, _ in ranked[:6] if rk in _ROLE_NAMES]
